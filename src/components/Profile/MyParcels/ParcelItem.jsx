...
const ParcelItem = ({ parcel }) => {
  return (
    <div className='py-3'>
      <div className='flex justify-between md:items-center bg-colBgGray2 px-2 py-4 md:p-4 lg:p-8 rounded-lg'>
        <div className='md:flex items-center md:space-x-4 w-full'>
          ...
          <div className='flex max-w-[250px] w-full'>
            ...
            <div>
              <h4 className='text-sm font-medium'>
                {parcel?.receiverCity?.nameRu},{' '}
                {parcel?.receiverCountry?.nameRu}
              </h4>
              <p className='text-xs text-colGray font-medium mt-1'>
                {parcel?.dateArrived}
              </p>
