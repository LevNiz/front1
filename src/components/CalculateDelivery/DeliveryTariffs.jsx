...
const DeliveryTariffs = ({ onButtonClick, parcelCost }) => {
  ...
  return (
    <div className='flex mt-10'>
      <div className='w-[66%] shadow-[0_8px_34px_#00000026] p-7 rounded-xl mr-10'>
        <h3 className='text-xl text-[#6747e5] pb-1 font-medium'>Тарифы</h3>
      ...
      <div className='w-[33%] shadow-[0_8px_34px_#00000026] p-7 rounded-xl h-[fit-content]'>
        ...
        <button
          ...
          className={`${
            !activeTariff ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-80'
          } uppercase font-medium p-4 rounded-lg bg-black text-white duration-150 max-w-[320px] w-full mt-4`}
        >
