...
import gbMain2 from '../../assets/images/gb-business-main2.png';
...
import gbBusinessBg from '../../assets/images/gb-business-bg.png';
      ...
      <div className=''>
        <div className='md:flex items-center justify-between md:space-x-5 min-h-[520px] pt-12 md:pt-0 content'>
          ...
          <div className='md:w-1/2 md:pt-0 pt-10'>
            <img className='mx-auto md:mx-0' src={gbMain} alt='*' />
          </div>
        </div>
        <div className='min-h-[500px] xs:min-h-[560px] ss:min-h-[620px] md:min-h-[520px] relative'>
          <div className='flex items-center justify-between flex-col md:flex-row md:space-x-5 content'>
            <div className='md:w-1/2 order-1 md:order-[-1]'>
              <img
                className='absolute mm:static md:absolute xl3:static top-48 md:-top-20 left-0 max-w-[420px] lg:max-w-[580px] w-full'
                src={gbMain2}
                alt='*'
              />
            </div>
        ...
        <div className='relative mt-24 mm:mt-32'>
