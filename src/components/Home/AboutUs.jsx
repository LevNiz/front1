    ...
    <div className='min-h-[850px] pt-14 lg:pt-[200px] pb-14 md:pb-32 content'>
      ...
      <div className='lg:flex sm:min-h-[520px] mt-12'>
        <div className='w-full lg:w-2/5 min-h-[440px] sm:min-h-[520px] relative'>
          ...
          <div className='max-w-[200px] sm:max-w-[275px] sm:min-w-[275px] max-height-[308px] min-height-[308px] absolute bottom-[60px] sm:bottom-0 left-0 sm:left-auto sm:right-[240px] lg:right-auto lg:left-0 z-20 overflow-hidden'>
            <img
              className='w-full h-full object-cover'
              src={aboutUsImg2}
              alt='*'
