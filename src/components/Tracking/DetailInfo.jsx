      ...
      <div className='pt-12 pb-20 content'>
        ...
        <div className='mm:flex'>
          ...
          <div className='w-full mm:w-3/6 lg:w-3/5 grid lg:grid-cols-2 gap-8'>
            <div className='bg-white w-full h-fit p-6 sm:p-10 rounded-[20px] relative flex flex-col justify-between'>
              <div className='flex'>
            ...
            <div className='bg-white w-full h-fit p-6 sm:p-10 rounded-[20px]'>
